...
PHP_METHOD(Phalcon_Security_Random, bytes) {
	...
	if ((zephir_function_exists_ex(SS("openssl_random_pseudo_bytes") TSRMLS_CC) == SUCCESS)) {
		...
		ZVAL_LONG(_1$$5, len);
		ZEPHIR_RETURN_CALL_FUNCTION("openssl_random_pseudo_bytes", NULL, 393, _1$$5);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_SINIT_VAR(_2);
	...
	if ((zephir_file_exists(&_2 TSRMLS_CC) == SUCCESS)) {
		...
		ZEPHIR_CALL_FUNCTION(&handle, "fopen", NULL, 280, &_3$$6, &_4$$6);
		zephir_check_call_status();
		if (!ZEPHIR_IS_FALSE_IDENTICAL(handle)) {
			ZEPHIR_SINIT_VAR(_5$$7);
			ZVAL_LONG(&_5$$7, 0);
			ZEPHIR_CALL_FUNCTION(NULL, "stream_set_read_buffer", NULL, 396, handle, &_5$$7);
			zephir_check_call_status();
			ZEPHIR_SINIT_NVAR(_5$$7);
			ZVAL_LONG(&_5$$7, len);
			ZEPHIR_CALL_FUNCTION(&ret, "fread", NULL, 397, handle, &_5$$7);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Security_Random, hex) {
	...
	ZEPHIR_SINIT_VAR(_2);
	ZVAL_STRING(&_2, "H*", 0);
	ZEPHIR_CALL_FUNCTION(&_3, "unpack", NULL, 398, &_2, _0);
	zephir_check_call_status();
	ZEPHIR_MAKE_REF(_3);
...
PHP_METHOD(Phalcon_Security_Random, base58) {
	...
	ZEPHIR_SINIT_VAR(_1);
	ZVAL_STRING(&_1, "C*", 0);
	ZEPHIR_CALL_FUNCTION(&bytes, "unpack", NULL, 398, &_1, _0);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Security_Random, uuid) {
	...
	ZEPHIR_CALL_FUNCTION(&_3, "unpack", NULL, 398, &_2, _0);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&ary, "array_values", NULL, 210, _3);
	zephir_check_call_status();
	...
	ZEPHIR_MAKE_REF(ary);
	ZEPHIR_CALL_FUNCTION(NULL, "array_unshift", NULL, 373, ary, _7);
...
PHP_METHOD(Phalcon_Security_Random, number) {
	...
	ZEPHIR_SINIT_VAR(_1);
	ZVAL_LONG(&_1, len);
	ZEPHIR_CALL_FUNCTION(&hex, "dechex", NULL, 399, &_1);
	zephir_check_call_status();
	...
	ZVAL_STRING(&_1, "H*", 0);
	ZEPHIR_CALL_FUNCTION(&_3, "pack", NULL, 400, &_1, hex);
	zephir_check_call_status();
	...
	do {
		...
		ZVAL_LONG(&_17$$6, 1);
		ZEPHIR_CALL_FUNCTION(&_18$$6, "substr_replace", &_19, 401, rnd, _13$$6, &_16$$6, &_17$$6);
		zephir_check_call_status();
		ZEPHIR_CPY_WRT(rnd, _18$$6);
	} while (ZEPHIR_LT(bin, rnd));
	ZEPHIR_SINIT_NVAR(_1);
	ZVAL_STRING(&_1, "H*", 0);
	ZEPHIR_CALL_FUNCTION(&ret, "unpack", NULL, 398, &_1, rnd);
	zephir_check_call_status();
	ZEPHIR_MAKE_REF(ret);
	ZEPHIR_CALL_FUNCTION(&_20, "array_shift", NULL, 122, ret);
	ZEPHIR_UNREF(ret);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("hexdec", NULL, 402, _20);
	zephir_check_call_status();
	RETURN_MM();
