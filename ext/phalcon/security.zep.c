...
PHP_METHOD(Phalcon_Security, getSaltBytes) {
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_2$$5, "openssl_random_pseudo_bytes", &_3, 393, _1$$5);
...
PHP_METHOD(Phalcon_Security, hash) {
	...
	do {
		...
		if (hash == 8) {
			...
			ZEPHIR_RETURN_CALL_FUNCTION("crypt", &_6, 394, password, _5$$11);
			zephir_check_call_status();
			RETURN_MM();
		}
		...
		ZEPHIR_CALL_FUNCTION(&_10$$13, "sprintf", NULL, 183, &_8$$13, &_9$$13);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(_11$$13);
		ZEPHIR_CONCAT_SVSVSV(_11$$13, "$2", variant, "$", _10$$13, "$", saltBytes);
		ZEPHIR_RETURN_CALL_FUNCTION("crypt", &_6, 394, password, _11$$13);
		zephir_check_call_status();
		RETURN_MM();
	} while(0);
...
PHP_METHOD(Phalcon_Security, getTokenKey) {
	...
	ZEPHIR_CALL_FUNCTION(&_2, "openssl_random_pseudo_bytes", NULL, 393, _1);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Security, getToken) {
	...
	ZEPHIR_CALL_FUNCTION(&token, "openssl_random_pseudo_bytes", NULL, 393, _0);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Security, computeHmac) {
	...
	ZEPHIR_CALL_FUNCTION(&hmac, "hash_hmac", NULL, 395, algo, data, key, &_0);
	zephir_check_call_status();
