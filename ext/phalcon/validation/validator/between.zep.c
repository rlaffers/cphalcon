...
PHP_METHOD(Phalcon_Validation_Validator_Between, validate) {
	...
	zval *field = NULL;
	zval *validation, *field_param = NULL, *value = NULL, *minimum = NULL, *maximum = NULL, *message = NULL, *label = NULL, *replacePairs = NULL, *_0 = NULL, *_1 = NULL, *_4$$4 = NULL, *_6$$4 = NULL, *_7$$4, *_5$$6;
	...
	if (_3) {
		...
		if (ZEPHIR_IS_EMPTY(message)) {
			...
			ZVAL_STRING(_5$$6, "Between", ZEPHIR_TEMP_PARAM_COPY);
		...
		ZVAL_STRING(_7$$4, "Between", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_METHOD(NULL, _4$$4, "__construct", NULL, 430, _6$$4, field, _7$$4);
