...
PHP_METHOD(Phalcon_Validation_Validator_Email, validate) {
	...
	ZEPHIR_SINIT_VAR(_3);
	ZVAL_LONG(&_3, 274);
	ZEPHIR_CALL_FUNCTION(&_4, "filter_var", NULL, 187, value, &_3);
	zephir_check_call_status();
	if (!(zephir_is_true(_4))) {
		...
		if (ZEPHIR_IS_EMPTY(message)) {
			...
			ZVAL_STRING(_6$$6, "Email", ZEPHIR_TEMP_PARAM_COPY);
		...
		ZVAL_STRING(_8$$4, "Email", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_METHOD(NULL, _5$$4, "__construct", NULL, 430, _7$$4, field, _8$$4);
