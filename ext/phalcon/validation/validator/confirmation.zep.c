...
PHP_METHOD(Phalcon_Validation_Validator_Confirmation, validate) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "compare", NULL, 433, value, valueWith);
	zephir_check_call_status();
	if (!(zephir_is_true(_1))) {
		...
		ZEPHIR_CALL_METHOD(NULL, _2$$3, "__construct", NULL, 430, _4$$3, field, _5$$3);
...
PHP_METHOD(Phalcon_Validation_Validator_Confirmation, compare) {
	...
	if (zephir_is_true(_0)) {
		...
		ZEPHIR_CALL_FUNCTION(&_4$$3, "mb_strtolower", &_5, 190, a, &_3$$3);
		zephir_check_call_status();
		zephir_get_strval(a, _4$$3);
		ZEPHIR_SINIT_NVAR(_3$$3);
		ZVAL_STRING(&_3$$3, "utf-8", 0);
		ZEPHIR_CALL_FUNCTION(&_6$$3, "mb_strtolower", &_5, 190, b, &_3$$3);
		zephir_check_call_status();
