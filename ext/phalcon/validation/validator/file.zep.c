...
PHP_METHOD(Phalcon_Validation_Validator_File, validate) {
	...
	if (_6) {
		...
		ZEPHIR_CALL_METHOD(NULL, _9$$4, "__construct", &_14, 430, _11$$4, field, _13$$4);
	...
	if (!(_23)) {
		...
		ZEPHIR_CALL_FUNCTION(&_25, "is_uploaded_file", NULL, 228, _24);
		zephir_check_call_status();
	...
	if (_23) {
		...
		ZEPHIR_CALL_METHOD(NULL, _26$$7, "__construct", &_14, 430, _28$$7, field, _29$$7);
	...
	if (_31) {
		...
		ZEPHIR_CALL_METHOD(NULL, _32$$9, "__construct", &_14, 430, _34$$9, field, _35$$9);
	...
	if (zephir_is_true(_36)) {
		...
		ZEPHIR_CALL_FUNCTION(&_42$$11, "floatval", &_43, 299, _41$$11);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_42$$11, "floatval", &_43, 299, _47$$11);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_48$$11, "floatval", &_43, 299, bytes);
		zephir_check_call_status();
		if (ZEPHIR_GT(_42$$11, _48$$11)) {
			...
			ZEPHIR_CALL_METHOD(NULL, _49$$13, "__construct", &_14, 430, _51$$13, field, _52$$13);
	...
	if (zephir_is_true(_53)) {
		...
		if ((zephir_function_exists_ex(SS("finfo_open") TSRMLS_CC) == SUCCESS)) {
			...
			ZVAL_LONG(&_55$$17, 16);
			ZEPHIR_CALL_FUNCTION(&tmp, "finfo_open", NULL, 225, &_55$$17);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&mime, "finfo_file", NULL, 226, tmp, _56$$17);
			zephir_check_call_status();
			ZEPHIR_CALL_FUNCTION(NULL, "finfo_close", NULL, 227, tmp);
			zephir_check_call_status();
		} else {
		...
		if (!(zephir_fast_in_array(mime, types TSRMLS_CC))) {
			...
			ZEPHIR_CALL_METHOD(NULL, _57$$19, "__construct", &_14, 430, _59$$19, field, _60$$19);
	...
	if (_62) {
		...
		ZEPHIR_CALL_FUNCTION(&tmp, "getimagesize", NULL, 236, _64$$21);
		zephir_check_call_status();
		...
		if (_69$$21) {
			...
			ZEPHIR_CALL_METHOD(NULL, _70$$24, "__construct", &_14, 430, _71$$24, field, _73$$24);
		...
		if (zephir_is_true(_74$$21)) {
			...
			if (_77$$26) {
				...
				ZEPHIR_CALL_METHOD(NULL, _78$$27, "__construct", &_14, 430, _79$$27, field, _81$$27);
