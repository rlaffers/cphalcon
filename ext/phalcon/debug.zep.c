...
PHP_METHOD(Phalcon_Debug, listenExceptions) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "set_exception_handler", NULL, 145, _0);
	zephir_check_call_status();
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Debug, listenLowSeverity) {
	...
	zephir_array_fast_append(_0, _1);
	ZEPHIR_CALL_FUNCTION(NULL, "set_error_handler", NULL, 146, _0);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_2);
	...
	ZEPHIR_CALL_FUNCTION(NULL, "set_exception_handler", NULL, 145, _2);
	zephir_check_call_status();
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Debug, debugVar) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "debug_backtrace", NULL, 147);
	zephir_check_call_status();
	zephir_array_fast_append(_0, _1);
	ZEPHIR_INIT_VAR(_2);
	zephir_time(_2);
...
PHP_METHOD(Phalcon_Debug, _escapeString) {
	...
	if (Z_TYPE_P(value) == IS_STRING) {
		...
		ZEPHIR_RETURN_CALL_FUNCTION("htmlentities", NULL, 148, _0$$3, &_3$$3, &_4$$3);
		zephir_check_call_status();
		RETURN_MM();
	}
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_2, &_1)
		...
		if (Z_TYPE_P(v) == IS_ARRAY) {
			...
			ZEPHIR_CALL_METHOD(&_6$$9, this_ptr, "_getarraydump", &_8, 149, v, _7$$9);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Debug, _getVarDump) {
	...
	if (Z_TYPE_P(variable) == IS_ARRAY) {
		ZEPHIR_CALL_METHOD(&_2$$11, this_ptr, "_getarraydump", &_1, 149, variable);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Debug, getMajorVersion) {
	...
	ZEPHIR_CALL_CE_STATIC(&_0, phalcon_version_ce, "get", &_1, 150);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Debug, getVersion) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_CE_STATIC(&_1, phalcon_version_ce, "get", &_2, 150);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Debug, showTraceItem) {
	...
	if (zephir_array_isset_string_fetch(&className, trace, SS("class"), 0 TSRMLS_CC)) {
		...
		if (zephir_is_true(_3$$3)) {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_8$$5, classReflection, "isinternal", NULL, 151);
			zephir_check_call_status();
		...
		zephir_array_fetch_string(&_14$$3, trace, SL("type"), PH_NOISY | PH_READONLY, "phalcon/debug.zep", 385 TSRMLS_CC);
	...
	if (zephir_array_isset_string(trace, SS("class"))) {
		...
		if ((zephir_function_exists(functionName TSRMLS_CC)  == SUCCESS)) {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_16$$10, functionReflection, "isinternal", NULL, 153);
			zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&traceArgs, trace, SS("args"), 0 TSRMLS_CC)) {
		if (zephir_fast_count_int(traceArgs TSRMLS_CC)) {
			...
			zephir_is_iterable(traceArgs, &_23$$15, &_22$$15, 0, 0, "phalcon/debug.zep", 439);
			for (
			  ...
			  ; zephir_hash_move_forward_ex(_23$$15, &_22$$15)
				...
				zephir_array_append(&arguments, _27$$16, PH_SEPARATE, "phalcon/debug.zep", 433);
			}
	...
	if (zephir_array_isset_string_fetch(&filez, trace, SS("file"), 0 TSRMLS_CC)) {
		...
		zephir_array_fetch_string(&_30$$18, trace, SL("line"), PH_NOISY, "phalcon/debug.zep", 450 TSRMLS_CC);
		...
		if (zephir_is_true(showFiles)) {
			...
			while (1) {
				...
				if (_45$$26) {
					...
					ZEPHIR_CALL_FUNCTION(&_51$$31, "htmlentities", &_52, 148, _46$$31, &_49$$31, &_50$$31);
					zephir_check_call_status();
	...
	if (zephir_is_true(showBackTrace)) {
		...
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_12$$5, &_11$$5)
			...
			ZEPHIR_CALL_METHOD(&_14$$7, this_ptr, "showtraceitem", &_15, 158, n, traceItem);
			zephir_check_call_status();
		...
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_17$$5, &_16$$5)
			...
			if (Z_TYPE_P(value) != IS_ARRAY) {
				...
				ZEPHIR_CALL_FUNCTION(&_20$$10, "print_r", &_21, 159, value, ZEPHIR_GLOBAL(global_true));
				zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_29$$5, "get_included_files", NULL, 160);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_34$$5, "memory_get_usage", NULL, 161, ZEPHIR_GLOBAL(global_true));
		zephir_check_call_status();
