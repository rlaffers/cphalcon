...
PHP_METHOD(Phalcon_Translate_Adapter_Gettext, __construct) {
	...
	ZEPHIR_CALL_PARENT(NULL, phalcon_translate_adapter_gettext_ce, this_ptr, "__construct", &_0, 420, options);
...
PHP_METHOD(Phalcon_Translate_Adapter_Gettext, query) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "func_num_args", NULL, 415);
	zephir_check_call_status();
	if (ZEPHIR_GT_LONG(_0, 2)) {
		ZEPHIR_SINIT_VAR(_1$$3);
		ZVAL_LONG(&_1$$3, 2);
		ZEPHIR_CALL_FUNCTION(&domain, "func_get_arg", NULL, 414, &_1$$3);
		zephir_check_call_status();
	} else {
	...
	if (!(zephir_is_true(domain))) {
		ZEPHIR_CALL_FUNCTION(&translation, "gettext", NULL, 423, index);
		zephir_check_call_status();
	} else {
		ZEPHIR_CALL_FUNCTION(&translation, "dgettext", NULL, 424, domain, index);
		zephir_check_call_status();
	}
...
PHP_METHOD(Phalcon_Translate_Adapter_Gettext, nquery) {
	...
	if (!(!(!domain) && Z_STRLEN_P(domain))) {
		...
		ZEPHIR_CALL_FUNCTION(&translation, "ngettext", NULL, 425, msgid1, msgid2, &_0$$3);
		zephir_check_call_status();
	} else {
		ZEPHIR_SINIT_VAR(_1$$4);
		ZVAL_LONG(&_1$$4, count);
		ZEPHIR_CALL_FUNCTION(&translation, "dngettext", NULL, 426, domain, msgid1, msgid2, &_1$$4);
		zephir_check_call_status();
	}
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "replaceplaceholders", NULL, 0, translation, placeholders);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Translate_Adapter_Gettext, setDomain) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("textdomain", NULL, 427, domain);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Translate_Adapter_Gettext, resetDomain) {
	...
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("textdomain", NULL, 427, _0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Translate_Adapter_Gettext, setDirectory) {
	...
	if (Z_TYPE_P(directory) == IS_ARRAY) {
		if (zephir_fast_count_int(directory TSRMLS_CC)) {
			zephir_is_iterable(directory, &_1$$4, &_0$$4, 0, 0, "phalcon/translate/adapter/gettext.zep", 181);
			for (
			  ...
			  ; zephir_hash_move_forward_ex(_1$$4, &_0$$4)
				...
				ZEPHIR_CALL_FUNCTION(NULL, "bindtextdomain", &_3, 428, key, value);
				zephir_check_call_status();
			}
		}
	} else {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(NULL, "bindtextdomain", &_3, 428, _4$$6, directory);
		zephir_check_call_status();
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Translate_Adapter_Gettext, setLocale) {
	...
	zval *locale = NULL;
	zval *category_param = NULL, *locale_param = NULL, *_0, *_1 = NULL, _2, *_3, *_4, *_5, _6;
	...
	ZEPHIR_INIT_VAR(_0);
	ZEPHIR_CALL_FUNCTION(&_1, "func_get_args", NULL, 162);
	zephir_check_call_status();
	ZEPHIR_SINIT_VAR(_2);
	...
	ZEPHIR_CALL_FUNCTION(NULL, "putenv", NULL, 429, _4);
	zephir_check_call_status();
	_5 = zephir_fetch_nproperty_this(this_ptr, SL("_locale"), PH_NOISY_CC);
	ZEPHIR_SINIT_VAR(_6);
	ZVAL_LONG(&_6, 6);
	ZEPHIR_CALL_FUNCTION(NULL, "setlocale", NULL, 409, &_6, _5);
	zephir_check_call_status();
