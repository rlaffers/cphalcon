...
PHP_METHOD(Phalcon_Session_Adapter_Memcache, __construct) {
	...
	ZEPHIR_CALL_METHOD(NULL, _4, "__construct", NULL, 307, _5);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, _3, "__construct", NULL, 310, _4, options);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_set_save_handler", NULL, 404, _7, _9, _10, _11, _12, _13);
	zephir_check_call_status();
	ZEPHIR_CALL_PARENT(NULL, phalcon_session_adapter_memcache_ce, this_ptr, "__construct", &_14, 405, options);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
