...
PHP_METHOD(Phalcon_Session_Adapter_Redis, __construct) {
	...
	ZEPHIR_CALL_METHOD(NULL, _2, "__construct", NULL, 311, _3, options);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_PARENT(NULL, phalcon_session_adapter_redis_ce, this_ptr, "__construct", &_13, 405, options);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
