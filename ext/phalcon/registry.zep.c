...
PHP_METHOD(Phalcon_Registry, next) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("_data"), PH_NOISY_CC);
	ZEPHIR_MAKE_REF(_0);
	ZEPHIR_CALL_FUNCTION(NULL, "next", NULL, 385, _0);
	ZEPHIR_UNREF(_0);
...
PHP_METHOD(Phalcon_Registry, key) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("_data"), PH_NOISY_CC);
	ZEPHIR_MAKE_REF(_0);
	ZEPHIR_RETURN_CALL_FUNCTION("key", NULL, 386, _0);
	ZEPHIR_UNREF(_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Registry, rewind) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("_data"), PH_NOISY_CC);
	ZEPHIR_MAKE_REF(_0);
	ZEPHIR_CALL_FUNCTION(NULL, "reset", NULL, 387, _0);
	ZEPHIR_UNREF(_0);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Registry, valid) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("_data"), PH_NOISY_CC);
	ZEPHIR_MAKE_REF(_0);
	ZEPHIR_CALL_FUNCTION(&_1, "key", NULL, 386, _0);
	ZEPHIR_UNREF(_0);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Registry, current) {
	...
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("_data"), PH_NOISY_CC);
	ZEPHIR_MAKE_REF(_0);
	ZEPHIR_RETURN_CALL_FUNCTION("current", NULL, 388, _0);
	ZEPHIR_UNREF(_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Registry, __set) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "offsetset", NULL, 389, key, value);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Registry, __get) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "offsetget", NULL, 390, key);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Registry, __isset) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "offsetexists", NULL, 391, key);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Registry, __unset) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "offsetunset", NULL, 392, key);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
