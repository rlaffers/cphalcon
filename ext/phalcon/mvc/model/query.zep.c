...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getCallArgument) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_getexpression", NULL, 312, argument);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getCaseExpression) {
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_2, &_1)
		...
		if (zephir_array_isset_string(whenExpr, SS("right"))) {
			...
			ZEPHIR_CALL_METHOD(&_5$$4, this_ptr, "_getexpression", &_7, 312, _6$$4);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(&_5$$4, this_ptr, "_getexpression", &_7, 312, _8$$4);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(&_10$$5, this_ptr, "_getexpression", &_7, 312, _11$$5);
			zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_12, this_ptr, "_getexpression", &_7, 312, _13);
	zephir_check_call_status();
		...
		if (zephir_array_isset_long(arguments, 0)) {
			...
			for (
			  ...
			  ; zephir_hash_move_forward_ex(_1$$6, &_0$$6)
				...
				ZEPHIR_CALL_METHOD(&_3$$7, this_ptr, "_getcallargument", &_4, 313, argument);
				zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(&_5$$8, this_ptr, "_getcallargument", &_4, 313, arguments);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getExpression) {
	...
	if (zephir_array_isset_string_fetch(&exprType, expr, SS("type"), 0 TSRMLS_CC)) {
		...
		if (!ZEPHIR_IS_LONG(exprType, 409)) {
			...
			if (zephir_array_isset_string_fetch(&exprLeft, expr, SS("left"), 0 TSRMLS_CC)) {
				...
				ZEPHIR_CALL_METHOD(&left, this_ptr, "_getexpression", &_1, 312, exprLeft, _0$$5);
				zephir_check_call_status();
			}
			...
			if (zephir_array_isset_string_fetch(&exprRight, expr, SS("right"), 0 TSRMLS_CC)) {
				...
				ZEPHIR_CALL_METHOD(&right, this_ptr, "_getexpression", &_1, 312, exprRight, _2$$6);
				zephir_check_call_status();
			}
		}
		do {
			...
			if (ZEPHIR_IS_LONG(exprType, 355)) {
				ZEPHIR_CALL_METHOD(&exprReturn, this_ptr, "_getqualified", &_3, 314, expr);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(exprType, '+')) {
			...
			if (ZEPHIR_IS_LONG(exprType, 350)) {
				ZEPHIR_CALL_METHOD(&exprReturn, this_ptr, "_getfunctioncall", NULL, 315, expr);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(exprType, 409)) {
				ZEPHIR_CALL_METHOD(&exprReturn, this_ptr, "_getcaseexpression", NULL, 316, expr);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(exprType, 309)) {
				...
				ZVAL_BOOL(_36$$68, 1);
				ZEPHIR_CALL_METHOD(&_35$$68, this_ptr, "_prepareselect", NULL, 317, expr, _36$$68);
				zephir_check_call_status();
	...
	if (zephir_array_isset_string(expr, SS("domain"))) {
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_getqualified", &_3, 314, expr);
		zephir_check_call_status();
		RETURN_MM();
	}
	if (zephir_array_isset_long(expr, 0)) {
		...
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_40$$71, &_39$$71)
			...
			ZEPHIR_CALL_METHOD(&_42$$72, this_ptr, "_getexpression", &_1, 312, exprListItem);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getSelectColumn) {
	...
	if (ZEPHIR_IS_LONG(columnType, 354)) {
		...
		ZEPHIR_CALL_METHOD(&sqlExprColumn, this_ptr, "_getexpression", NULL, 312, columnData);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getSingleJoin) {
	...
	if (Z_TYPE_P(fields) != IS_ARRAY) {
		...
		ZEPHIR_CALL_METHOD(&_1$$3, this_ptr, "_getqualified", &_3, 314, _2$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_1$$3, this_ptr, "_getqualified", &_3, 314, _4$$3);
		zephir_check_call_status();
		...
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_6$$4, &_5$$4)
			...
			ZEPHIR_CALL_METHOD(&_13$$5, this_ptr, "_getqualified", &_3, 314, _14$$5);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(&_13$$5, this_ptr, "_getqualified", &_3, 314, _15$$5);
			zephir_check_call_status();
	...
	if (Z_TYPE_P(fields) == IS_ARRAY) {
		...
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_1$$3, &_0$$3)
			...
			ZEPHIR_CALL_METHOD(&_7$$4, this_ptr, "_getqualified", &_9, 314, _8$$4);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(&_7$$4, this_ptr, "_getqualified", &_9, 314, _10$$4);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_14$$6, this_ptr, "_getqualified", &_9, 314, _15$$6);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_14$$6, this_ptr, "_getqualified", &_9, 314, _16$$6);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_14$$6, this_ptr, "_getqualified", &_9, 314, _17$$6);
		zephir_check_call_status();
		zephir_array_update_string(&_13$$6, SL("left"), &_14$$6, PH_COPY | PH_SEPARATE);
		...
		ZEPHIR_CALL_METHOD(&_14$$6, this_ptr, "_getqualified", &_9, 314, _18$$6);
		zephir_check_call_status();
		zephir_array_update_string(&_13$$6, SL("right"), &_14$$6, PH_COPY | PH_SEPARATE);
		zephir_array_fast_append(_12$$6, _13$$6);
		zephir_array_update_string(&_11$$6, SL("conditions"), &_12$$6, PH_COPY | PH_SEPARATE);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getJoins) {
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_1, &_0)
		...
		ZEPHIR_CALL_METHOD(&joinData, this_ptr, "_getjoin", &_3, 318, manager, joinItem);
		zephir_check_call_status();
		ZEPHIR_OBS_NVAR(source);
		...
		ZEPHIR_CALL_METHOD(&joinType, this_ptr, "_getjointype", &_4, 319, joinItem);
		zephir_check_call_status();
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_13, &_12)
		...
		if (zephir_array_isset_string_fetch(&joinExpr, joinItem, SS("conditions"), 0 TSRMLS_CC)) {
			ZEPHIR_CALL_METHOD(&_15$$13, this_ptr, "_getexpression", &_16, 312, joinExpr);
			zephir_check_call_status();
			...
			if (!(zephir_array_isset_fetch(&preCondition, joinPreCondition, joinAlias, 0 TSRMLS_CC))) {
				...
				if (Z_TYPE_P(relation) == IS_OBJECT) {
					...
					if (!(zephir_is_true(_41$$23))) {
						ZEPHIR_CALL_METHOD(&sqlJoin, this_ptr, "_getsinglejoin", &_42, 320, joinType, joinSource, modelAlias, joinAlias, relation);
						zephir_check_call_status();
					} else {
						ZEPHIR_CALL_METHOD(&sqlJoin, this_ptr, "_getmultijoin", &_43, 321, joinType, joinSource, modelAlias, joinAlias, relation);
						zephir_check_call_status();
					}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getOrderClause) {
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_1, &_0)
		...
		ZEPHIR_CALL_METHOD(&orderPartExpr, this_ptr, "_getexpression", &_4, 312, _3$$5);
		zephir_check_call_status();
	...
	if (zephir_array_isset_long(group, 0)) {
		...
		for (
		  ...
		  ; zephir_hash_move_forward_ex(_1$$3, &_0$$3)
			...
			ZEPHIR_CALL_METHOD(&_3$$4, this_ptr, "_getexpression", &_4, 312, groupItem);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_5$$5, this_ptr, "_getexpression", &_4, 312, group);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getLimitClause) {
	...
	if (zephir_array_isset_string_fetch(&number, limitClause, SS("number"), 0 TSRMLS_CC)) {
		ZEPHIR_CALL_METHOD(&_0$$3, this_ptr, "_getexpression", &_1, 312, number);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&offset, limitClause, SS("offset"), 0 TSRMLS_CC)) {
		ZEPHIR_CALL_METHOD(&_2$$4, this_ptr, "_getexpression", &_1, 312, offset);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareSelect) {
	...
	if (zephir_fast_count_int(joins TSRMLS_CC)) {
		...
		ZEPHIR_CALL_METHOD(&sqlJoins, this_ptr, "_getjoins", &_41, 322, select);
		zephir_check_call_status();
	} else {
		if (zephir_fast_count_int(automaticJoins TSRMLS_CC)) {
			zephir_array_update_string(&select, SL("joins"), &automaticJoins, PH_COPY | PH_SEPARATE);
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_43, &_42)
		...
		ZEPHIR_CALL_METHOD(&_45$$41, this_ptr, "_getselectcolumn", &_46, 323, column);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&where, ast, SS("where"), 0 TSRMLS_CC)) {
		ZEPHIR_CALL_METHOD(&_53$$51, this_ptr, "_getexpression", &_54, 312, where);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&groupBy, ast, SS("groupBy"), 0 TSRMLS_CC)) {
		ZEPHIR_CALL_METHOD(&_55$$52, this_ptr, "_getgroupclause", NULL, 324, groupBy);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&having, ast, SS("having"), 0 TSRMLS_CC)) {
		ZEPHIR_CALL_METHOD(&_56$$53, this_ptr, "_getexpression", &_54, 312, having);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&order, ast, SS("orderBy"), 0 TSRMLS_CC)) {
		ZEPHIR_CALL_METHOD(&_57$$54, this_ptr, "_getorderclause", NULL, 325, order);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&limit, ast, SS("limit"), 0 TSRMLS_CC)) {
		ZEPHIR_CALL_METHOD(&_58$$55, this_ptr, "_getlimitclause", NULL, 326, limit);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareInsert) {
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_6, &_5)
		...
		ZEPHIR_CALL_METHOD(&_10$$9, this_ptr, "_getexpression", &_12, 312, exprValue, _11$$9);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareUpdate) {
	...
	for (
	  ...
	  ; zephir_hash_move_forward_ex(_10, &_9)
		...
		ZEPHIR_CALL_METHOD(&_12$$17, this_ptr, "_getexpression", &_15, 312, _13$$17, _14$$17);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_18$$17, this_ptr, "_getexpression", &_15, 312, exprColumn, _19$$17);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&where, ast, SS("where"), 0 TSRMLS_CC)) {
		ZEPHIR_INIT_VAR(_21$$18);
		ZVAL_BOOL(_21$$18, 1);
		ZEPHIR_CALL_METHOD(&_20$$18, this_ptr, "_getexpression", &_15, 312, where, _21$$18);
		zephir_check_call_status();
		zephir_array_update_string(&sqlUpdate, SL("where"), &_20$$18, PH_COPY | PH_SEPARATE);
	}
	ZEPHIR_OBS_VAR(limit);
	if (zephir_array_isset_string_fetch(&limit, ast, SS("limit"), 0 TSRMLS_CC)) {
		ZEPHIR_CALL_METHOD(&_22$$19, this_ptr, "_getlimitclause", NULL, 326, limit);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareDelete) {
	...
	if (zephir_array_isset_string_fetch(&where, ast, SS("where"), 0 TSRMLS_CC)) {
		...
		ZVAL_BOOL(_10$$14, 1);
		ZEPHIR_CALL_METHOD(&_9$$14, this_ptr, "_getexpression", NULL, 312, where, _10$$14);
		zephir_check_call_status();
		zephir_array_update_string(&sqlDelete, SL("where"), &_9$$14, PH_COPY | PH_SEPARATE);
	}
	ZEPHIR_OBS_VAR(limit);
	if (zephir_array_isset_string_fetch(&limit, ast, SS("limit"), 0 TSRMLS_CC)) {
		ZEPHIR_CALL_METHOD(&_11$$15, this_ptr, "_getlimitclause", NULL, 326, limit);
		zephir_check_call_status();
		...
		if (zephir_array_isset_string_fetch(&type, ast, SS("type"), 0 TSRMLS_CC)) {
			...
			do {
				if (ZEPHIR_IS_LONG(type, 309)) {
					ZEPHIR_CALL_METHOD(&irPhql, this_ptr, "_prepareselect", NULL, 317);
					zephir_check_call_status();
					break;
				}
				if (ZEPHIR_IS_LONG(type, 306)) {
					ZEPHIR_CALL_METHOD(&irPhql, this_ptr, "_prepareinsert", NULL, 327);
					zephir_check_call_status();
					break;
				}
				if (ZEPHIR_IS_LONG(type, 300)) {
					ZEPHIR_CALL_METHOD(&irPhql, this_ptr, "_prepareupdate", NULL, 328);
					zephir_check_call_status();
					break;
				}
				if (ZEPHIR_IS_LONG(type, 303)) {
					ZEPHIR_CALL_METHOD(&irPhql, this_ptr, "_preparedelete", NULL, 329);
					zephir_check_call_status();
					break;
				}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _executeSelect) {
	...
	if (isComplex == 0) {
		...
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 330, simpleColumnMap, resultObject, resultData, cache, _55$$53);
		zephir_check_call_status();
		RETURN_MM();
	}
	object_init_ex(return_value, phalcon_mvc_model_resultset_complex_ce);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 331, columns1, resultData, cache);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _executeInsert) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 332, _20, insertModel);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _executeUpdate) {
	...
	ZEPHIR_CALL_METHOD(&records, this_ptr, "_getrelatedrecords", NULL, 333, model, intermediate, selectBindParams, selectBindTypes);
	zephir_check_call_status();
	if (!(zephir_fast_count_int(records TSRMLS_CC))) {
		object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
		ZEPHIR_INIT_VAR(_17$$19);
		ZVAL_BOOL(_17$$19, 1);
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", &_18, 332, _17$$19);
		zephir_check_call_status();
		RETURN_MM();
	}
	if ((zephir_method_exists_ex(model, SS("selectwriteconnection") TSRMLS_CC) == SUCCESS)) {
	...
	for (;_19->funcs->valid(_19 TSRMLS_CC) == SUCCESS && !EG(exception); _19->funcs->move_forward(_19 TSRMLS_CC)) {
		...
		if (!(zephir_is_true(_20$$23))) {
			...
			ZVAL_BOOL(_22$$24, 0);
			ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", &_18, 332, _22$$24, record);
			zephir_check_call_status();
			RETURN_MM();
		}
	}
	...
	ZEPHIR_INIT_VAR(_23);
	ZVAL_BOOL(_23, 1);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", &_18, 332, _23);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _executeDelete) {
	...
	ZEPHIR_CALL_METHOD(&records, this_ptr, "_getrelatedrecords", NULL, 333, model, intermediate, bindParams, bindTypes);
	zephir_check_call_status();
	if (!(zephir_fast_count_int(records TSRMLS_CC))) {
		object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
		ZEPHIR_INIT_VAR(_2$$5);
		ZVAL_BOOL(_2$$5, 1);
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", &_3, 332, _2$$5);
		zephir_check_call_status();
		RETURN_MM();
	}
	if ((zephir_method_exists_ex(model, SS("selectwriteconnection") TSRMLS_CC) == SUCCESS)) {
	...
	for (;_4->funcs->valid(_4 TSRMLS_CC) == SUCCESS && !EG(exception); _4->funcs->move_forward(_4 TSRMLS_CC)) {
		...
		if (!(zephir_is_true(_5$$9))) {
			...
			ZVAL_BOOL(_7$$10, 0);
			ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", &_3, 332, _7$$10, record);
			zephir_check_call_status();
			RETURN_MM();
		}
	}
	...
	ZEPHIR_INIT_VAR(_8);
	ZVAL_BOOL(_8, 1);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", &_3, 332, _8);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getRelatedRecords) {
	...
	ZEPHIR_CALL_METHOD(NULL, query, "__construct", NULL, 334);
	zephir_check_call_status();
	_5 = zephir_fetch_nproperty_this(this_ptr, SL("_dependencyInjector"), PH_NOISY_CC);
	ZEPHIR_CALL_METHOD(NULL, query, "setdi", NULL, 335, _5);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(_2);
	ZVAL_LONG(_2, 309);
	ZEPHIR_CALL_METHOD(NULL, query, "settype", NULL, 336, _2);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, query, "setintermediate", NULL, 337, selectIr);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_METHOD(query, "execute", NULL, 338, bindParams, bindTypes);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, execute) {
	...
	do {
		if (ZEPHIR_IS_LONG(type, 309)) {
			ZEPHIR_CALL_METHOD(&result, this_ptr, "_executeselect", NULL, 339, intermediate, mergedParams, mergedTypes);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_LONG(type, 306)) {
			ZEPHIR_CALL_METHOD(&result, this_ptr, "_executeinsert", NULL, 340, intermediate, mergedParams, mergedTypes);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_LONG(type, 300)) {
			ZEPHIR_CALL_METHOD(&result, this_ptr, "_executeupdate", NULL, 341, intermediate, mergedParams, mergedTypes);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_LONG(type, 303)) {
			ZEPHIR_CALL_METHOD(&result, this_ptr, "_executedelete", NULL, 342, intermediate, mergedParams, mergedTypes);
			zephir_check_call_status();
			break;
		}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getSingleResult) {
	...
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "execute", NULL, 338, bindParams, bindTypes);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getSql) {
	...
	if (ZEPHIR_IS_LONG(_0, 309)) {
		...
		ZVAL_BOOL(_3$$3, 1);
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_executeselect", NULL, 339, intermediate, _1$$3, _2$$3, _3$$3);
		zephir_check_call_status();
		RETURN_MM();
	}
