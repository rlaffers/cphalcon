...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, limit) {
	...
	int limit = 0, offset;
	zval *sqlQuery_param = NULL, *number, _8, *_0$$4, *_1$$4, _2$$4, *_3$$3, *_4$$3, _5$$3, *_6$$5, _7$$5, _10$$6;
	zval *sqlQuery = NULL, *_9, *_11$$6;
	...
	ZVAL_LONG(&_8, limit);
	ZEPHIR_INIT_VAR(_9);
	ZEPHIR_CONCAT_SVSVS(_9, "SELECT * FROM (SELECT Z1.*, ROWNUM PHALCON_RN FROM (", sqlQuery, ") Z1 WHERE ROWNUM <= ", &_8, ")");
	ZEPHIR_CPY_WRT(sqlQuery, _9);
	if (offset != 0) {
		ZEPHIR_SINIT_VAR(_10$$6);
		ZVAL_LONG(&_10$$6, offset);
		ZEPHIR_INIT_VAR(_11$$6);
		ZEPHIR_CONCAT_SV(_11$$6, " WHERE PHALCON_RN >= ", &_10$$6);
		zephir_concat_self(&sqlQuery, _11$$6 TSRMLS_CC);
	}
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, getColumnDefinition) {
	...
	do {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(_0$$14, "phalcon/db/dialect/oracle.zep", 125 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	} while(0);
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, dropIndex) {
	...
	ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_db_exception_ce, "Not implemented yet", "phalcon/db/dialect/oracle.zep", 168);
	return;
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, addPrimaryKey) {
	...
	ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_db_exception_ce, "Not implemented yet", "phalcon/db/dialect/oracle.zep", 176);
	return;
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, dropPrimaryKey) {
	...
	ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_db_exception_ce, "Not implemented yet", "phalcon/db/dialect/oracle.zep", 184);
	return;
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, addForeignKey) {
	...
	ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_db_exception_ce, "Not implemented yet", "phalcon/db/dialect/oracle.zep", 192);
	return;
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, dropForeignKey) {
	...
	ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_db_exception_ce, "Not implemented yet", "phalcon/db/dialect/oracle.zep", 200);
	return;
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, createTable) {
	...
	ZEPHIR_THROW_EXCEPTION_DEBUG_STR(phalcon_db_exception_ce, "Not implemented yet", "phalcon/db/dialect/oracle.zep", 208);
	return;
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, viewExists) {
	...
	if (!ZEPHIR_IS_STRING(schemaName, "")) {
		ZEPHIR_CALL_CE_STATIC(&_0$$3, phalcon_text_ce, "upper", &_1, 139, viewName);
		zephir_check_call_status();
		ZEPHIR_CALL_CE_STATIC(&_2$$3, phalcon_text_ce, "upper", &_1, 139, schemaName);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_CE_STATIC(&_3, phalcon_text_ce, "upper", &_1, 139, viewName);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, listViews) {
	...
	if (!ZEPHIR_IS_STRING(schemaName, "")) {
		ZEPHIR_CALL_CE_STATIC(&_0$$3, phalcon_text_ce, "upper", &_1, 139, schemaName);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, tableExists) {
	...
	if (!ZEPHIR_IS_STRING(schemaName, "")) {
		ZEPHIR_CALL_CE_STATIC(&_0$$3, phalcon_text_ce, "upper", &_1, 139, tableName);
		zephir_check_call_status();
		ZEPHIR_CALL_CE_STATIC(&_2$$3, phalcon_text_ce, "upper", &_1, 139, schemaName);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_CE_STATIC(&_3, phalcon_text_ce, "upper", &_1, 139, tableName);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, describeColumns) {
	...
	if (!ZEPHIR_IS_STRING(schema, "")) {
		ZEPHIR_CALL_CE_STATIC(&_0$$3, phalcon_text_ce, "upper", &_1, 139, table);
		zephir_check_call_status();
		ZEPHIR_CALL_CE_STATIC(&_2$$3, phalcon_text_ce, "upper", &_1, 139, schema);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_CE_STATIC(&_3, phalcon_text_ce, "upper", &_1, 139, table);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, describeReferences) {
	...
	if (!ZEPHIR_IS_STRING(schema, "")) {
		ZEPHIR_CALL_CE_STATIC(&_0$$3, phalcon_text_ce, "upper", &_1, 139, schema);
		zephir_check_call_status();
		ZEPHIR_CALL_CE_STATIC(&_2$$3, phalcon_text_ce, "upper", &_1, 139, table);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(_3$$3);
		ZEPHIR_CONCAT_SVSVS(_3$$3, "AND AC.OWNER='", _0$$3, "' AND AC.TABLE_NAME = '", _2$$3, "'");
		zephir_concat_self(&sql, _3$$3 TSRMLS_CC);
	} else {
		ZEPHIR_CALL_CE_STATIC(&_4$$4, phalcon_text_ce, "upper", &_1, 139, table);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Oracle, prepareTable) {
	...
	ZEPHIR_CALL_CE_STATIC(&_1, phalcon_text_ce, "upper", &_2, 139, table);
	zephir_check_call_status();
	ZEPHIR_CALL_CE_STATIC(&_3, phalcon_text_ce, "upper", &_2, 139, schema);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_PARENT(phalcon_db_dialect_oracle_ce, this_ptr, "preparetable", &_0, 140, _1, _3, alias, escapeChar);
	zephir_check_call_status();
	RETURN_MM();
